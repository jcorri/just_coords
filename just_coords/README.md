...
To display the list of all available commands and their usage, use:

    /coords

Initial settings for mode, color, font size, and display position can be configured for all players in the Luanti launcher:

    Settings → Content: Mods → just_coords

_______

This mod has been created by jcorri with the valuable help of the Copilot IA.
